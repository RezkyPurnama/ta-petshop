    ...
    <div class="row g-5 align-items-center">
        ...
        <div class="col-lg-6">
            <div class="position-relative border rounded shadow-sm overflow-hidden">
                <img src="{{ asset('storage/' . $produk->gambar_produk) }}" alt="{{ $produk->nama_produk }}" class="img-fluid rounded w-100">
        ...
        <div class="col-lg-6">
            ...
            <p class="mb-3">
                ...
                <span class="badge bg-success text-white">{{ $produk->stockproduk->stock ?? 0 }} {{ $produk->satuan ?? 'item' }}</span>
            </p>
            ...
            <form action="{{ route('keranjang.store') }}" method="POST" class="d-flex align-items-center gap-3 flex-wrap">
                @csrf
                ...
                <input type="number"
                       ...
                       class="form-control w-25 text-center border-dark rounded"
