      ...
      <form action="{{ route('data-pethotel.update', $pethotel->id) }}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="jenis_hewan" id="jenis_hewan"
                 ...
                 value="{{ old('jenis_hewan', $pethotel->jenis_hewan) }}" required>
          @error('jenis_hewan')
            <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
        ...
        <div class="mb-3">
          ...
          <textarea name="riwayat_sakit" id="riwayat_sakit"
                    class="form-control @error('riwayat_sakit') is-invalid @enderror"
