    ...
    <div class="container mt-4">
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                {{-- Cetak PDF bisa ditambahkan jika ada route --}}
                {{-- <a href="{{ route('data-pesanan.laporan.pdf') }}" class="btn btn-primary">
                                            ...
                                            <form action="{{ route('data-pesanan.update', $pesanan->id) }}" method="POST">
                                                ...
                                                <select name="status" class="form-select form-select-sm"
                                                    ...
                                                    @if ($pesanan->status == 'tunggu_pembayaran')
                                                        <option value="tunggu_pembayaran" selected>Menunggu Pembayaran
                                                        </option>
                                                        <option value="sedang_diproses">Sedang Diproses</option>
                                                        <option value="cancel">Cancel</option>
                                                        <!-- Cancel hanya boleh dari tunggu_pembayaran -->
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('data-pesanan.show', $pesanan->id) }}">
                                                        <i class="bx bx-show-alt me-1"></i> Detail
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('data-pesanan.edit', $pesanan->id) }}">
                                                        <i class="bx bx-edit-alt me-1"></i> Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <form action="{{ route('data-pesanan.destroy', $pesanan->id) }}"
