...
<div class="container mt-4">
    <div class="card shadow">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('data-grooming.laporan.pdf', ['bulan' => request('bulan'), 'tahun' => request('tahun')]) }}" class="btn btn-primary">
        ...
        <div class="card-body">
            {{-- Filter Bulan & Tahun --}}
            <form action="{{ route('data-grooming.index') }}" method="GET" class="row g-2 mb-3" id="filterForm">
                <div class="col-auto">
                            ...
                            <td class="text-center">
                                <div class="dropdown position-static">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="{{ route('data-grooming.show', $grooming->id) }}"><i class="bx bx-show-alt me-1"></i> Detail</a></li>
                                        <li><a class="dropdown-item" href="{{ route('data-grooming.edit', $grooming->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a></li>
                                        <li>
...
document.querySelectorAll('select[name="bulan"], select[name="tahun"]').forEach(el => {
    el.addEventListener('change', function() {
        ...
        fetch(`{{ route('data-grooming.index') }}?bulan=${bulan}&tahun=${tahun}`)
            .then(response => response.text())
            .then(html => {
                document.querySelector('.table-responsive').innerHTML =
                    new DOMParser().parseFromString(html, 'text/html')
                    .querySelector('.table-responsive').innerHTML;
            });
    });
});
</script>
